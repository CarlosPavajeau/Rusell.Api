...
public class ByReceiverGetControllerTest : BankDraftsContextApplicationTestCase
{
    public ByReceiverGetControllerTest(BankDraftsWebApplicationFactory<Program> factory) : base(factory)
    {
        CreateAuthenticatedClient();
    }

    [Fact]
    public async Task GetBySender_Should_Return_All_BankDrafts_By_Receiver()
    {
        ...
        var response =
            await Client.GetAsync($"api/bank-drafts/by-receiver/{receiver.Id.Value}");
