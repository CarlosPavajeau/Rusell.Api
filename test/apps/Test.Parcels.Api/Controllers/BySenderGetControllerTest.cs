...
public class BySenderGetControllerTest : ParcelsContextApplicationTestCase
{
    public BySenderGetControllerTest(ParcelsWebApplicationFactory<Program> factory) : base(factory)
    {
        CreateAuthenticatedClient();
    }

    [Fact]
    public async Task GetBySender_Should_Return_All_Parcels_By_Sender()
    {
        ...
        var response = await Client.GetAsync($"api/parcels/by-sender/{sender.Id.Value}");
