...
public class CompaniesWebApplicationFactory<TStartup> : ApplicationTestCase<TStartup> where TStartup : class
{
    ...
    protected override Action<IServiceCollection> Services()
    {
        return services =>
        {
            ...
            services.RemoveAll(typeof(DbContextOptions<CompaniesDbContext>));
            ...
            var context = scopedServices.GetRequiredService<CompaniesDbContext>();
