...
public class TicketsWebApplicationFactory<TStartup> : ApplicationTestCase<TStartup> where TStartup : class
{
    ...
    protected override Action<IServiceCollection> Services()
    {
        return services =>
        {
            ...
            services.RemoveAll(typeof(DbContextOptions<TicketsDbContext>));
            ...
            var context = scopedServices.GetRequiredService<TicketsDbContext>();
