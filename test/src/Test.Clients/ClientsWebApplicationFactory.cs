...
public class ClientsWebApplicationFactory<TStartup> : ApplicationTestCase<TStartup> where TStartup : class
{
    ...
    protected override Action<IServiceCollection> Services()
    {
        return services =>
        {
            ...
            services.RemoveAll(typeof(DbContextOptions<ClientsDbContext>));
